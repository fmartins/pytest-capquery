...
def test_insert_and_select_normalization(mysql_session, mysql_capquery):
    ...
    mysql_capquery.assert_executed_queries(
        "BEGIN",
        (
            "INSERT INTO alarm_panels (mac_address, is_online) VALUES (%(mac_address)s, %(is_online)s)",
            {"mac_address": "00:11:22:33:44:55", "is_online": 1}
        ),
        (
            "INSERT INTO sensors (panel_id, name, sensor_type) VALUES (%(panel_id)s, %(name)s, %(sensor_type)s)",
